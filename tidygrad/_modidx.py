...
d = { 'settings': { 'branch': 'master',
                ...
                'lib_path': 'tidygrad'},
  'syms': { 'tidygrad.tensor': { 'tidygrad.tensor.Add': ('tensor.html#add', 'tidygrad/tensor.py'),
                                 ...
                                 'tidygrad.tensor.Relu': ('tensor.html#relu', 'tidygrad/tensor.py'),
                                 'tidygrad.tensor.Relu.__init__': ('tensor.html#relu.__init__', 'tidygrad/tensor.py'),
                                 'tidygrad.tensor.Relu.backward': ('tensor.html#relu.backward', 'tidygrad/tensor.py'),
                                 'tidygrad.tensor.Sigmoid': ('tensor.html#sigmoid', 'tidygrad/tensor.py'),
                                 'tidygrad.tensor.Sigmoid.__init__': ('tensor.html#sigmoid.__init__', 'tidygrad/tensor.py'),
                                 'tidygrad.tensor.Sigmoid.backward': ('tensor.html#sigmoid.backward', 'tidygrad/tensor.py'),
